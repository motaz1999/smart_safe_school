...
class _StudentProfileScreenState extends State<StudentProfileScreen> {
  ...
  Future<void> _loadUserProfile() async {
    try {
      ...
      _parentContactController = TextEditingController(text: _userProfile?.parentContact ?? '');
      _classNameController = TextEditingController(text: _userProfile?.className ?? '');
                          ...
                          child: Stack(
                            children: [
                              CircleAvatar(
                                ...
                                child: Text(
                                  _userProfile?.name.substring(0, 1).toUpperCase() ?? 'S',
    ...
    return Column(
      ...
      children: [
        ...
        TextFormField(
          ...
          validator: (value) {
            if (value == null || value.isEmpty) {
              return 'Please enter parent contact information';
            }
            return null;
          },
        ),
