...
class ManageStudentsContent extends StatefulWidget {
  final VoidCallback? onAddStudent;

  const ManageStudentsContent({super.key, this.onAddStudent});

  @override
  State<ManageStudentsContent> createState() => ManageStudentsContentState();
}

class ManageStudentsContentState extends State<ManageStudentsContent> {
  ...
  // Public method to show the add student dialog
    ...
    showDialog(
      ...
      builder: (context) => StudentFormDialog(
        ...
        onSave: (studentData) async {
          try {
            print('🔍 DEBUG: ManageStudentsContent - Adding new student: ${studentData['name']}');
            ...
            print('🔍 DEBUG: ManageStudentsContent - Student added successfully, reloading data...');
            await _loadData();
            if (mounted) {
            ...
            print('❌ DEBUG: ManageStudentsContent - Error adding student: $e');
            print('❌ DEBUG: ManageStudentsContent - Error type: ${e.runtimeType}');
            if (e is Error) {
              print('❌ DEBUG: ManageStudentsContent - Stack trace: ${e.stackTrace}');
            }
    ...
    showDialog(
      ...
      builder: (context) => ChangePasswordDialog(
        ...
        onSave: (newPassword) async {
          try {
            await _adminService.changeUserPassword(student.id, newPassword);
            if (mounted) {
              ScaffoldMessenger.of(context).showSnackBar(
